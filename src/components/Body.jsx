...
const Body = () => {
    ...
    return (
        <div className="w-full p-6 flex flex-col gap-6">
            ...
            <div className="flex flex-row item-start gap-4 w-full overflow-auto">
                {
...
function Card({ data }) {
    ...
    return (
        <div className="bg-blue-300 p-4 rounded-xl flex-col flex gap-y-3 min-w-72 max-w-80">
        ...
        <div className="w-full flex flex-row items-center justify-between">
            <section className="flex flex-row gap-x-5">
                <div className="flex flex-row items-center relative">
                    <select {...setDateRange} name="date" id="date" className="px-4 py-2 cursor-pointer pr-10 appearance-none bg-blue-500 text-white rounded-lg">
                ...
                <div className="flex flex-row items-center relative">
                    <select {...setType} name="type" id="type" className="px-4 py-2 cursor-pointer pr-10 appearance-none bg-blue-500 text-white rounded-lg">
